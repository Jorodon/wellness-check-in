...
# ------- This file contains tests for the authentication functionality of the wellness check-in application. ------- #
...
def test_login_02(client, app):
    ...
    with app.app_context():
        user = User.query.filter_by(email="wellnessRules@ufl.edu".lower()).first()
